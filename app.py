...
custom_colors = ['rgba(13, 17, 201, 1)', 'rgba(56, 96, 229, 1)', 'rgba(83, 123, 225, 1)', 'rgba(160, 192, 250, 1)']
...
# Load raw data
deal_data = pd.read_excel('./data/compensationModelTaskData.xlsx', sheet_name='Deal Data')
ae_data = pd.read_excel('./data/compensationModelTaskData.xlsx', sheet_name='AE Data')


# Run the compensation calculation
deal_data, ae_data = calculate_compensation(deal_data, ae_data, exceptions=[
    {#here I am building the model without catching the error that the deal_id is in the data
