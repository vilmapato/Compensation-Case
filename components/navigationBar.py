...
def NavigationBar():
    return html.Div(
        [
            ...
            dcc.Link(
                "AE Compensation", href="/aeCompensation", className="tab", id="tab-ae"
            ),
            dcc.Link(
            ...
            dcc.Link(
                "Quota Strategy", href="/quotaStrategy", className="tab", id="tab-quota"
            ),
            dcc.Link(
                "Model Overview", href="/modelOverview", className="tab", id="tab-model"
            ),
            dcc.Link(
                "Data Explorer",
                href="/dataExplorer",
